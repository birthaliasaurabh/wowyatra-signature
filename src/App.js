...
const PACKAGES = [
  // 1. THE HERO PACKAGE (MOVED TO FIRST POSITION)
  {
    ...
    image:
      "https://images.unsplash.com/photo-1543884394-5b23d9b4b9b9?auto=format&fit=crop&q=80&w=1000",
  ...
  // 2. LONDON ROYAL FAMILY EXPERIENCE (NOW SECOND)
  {
    ...
    image:
      "https://images.unsplash.com/photo-1577741270273-d1447029580a?auto=format&fit=crop&q=80&w=1000",
  ...
  // 3. NEW EUROPE CLASSIC PACKAGE (NOW THIRD)
  {
    ...
    image:
      "https://images.unsplash.com/photo-1502602898624-ad8744093c83?auto=format&fit=crop&q=80&w=1000",
  ...
  // 4. NEW EUROPE HONEYMOON PACKAGE (NOW FOURTH)
  {
    ...
    image:
      "https://images.unsplash.com/photo-1490650577907-73d8a9e7019f?auto=format&fit=crop&q=80&w=1000",
  ...
  // 5. MID-RANGE SCOTLAND PACKAGE (NOW FIFTH)
  {
    ...
    image:
      "https://images.unsplash.com/photo-1502781252882-974a95c3746a?auto=format&fit=crop&q=80&w=1000",
  ...
  // 6. TOP-TIER LUXURY SCOTLAND PACKAGE (NOW LAST)
  {
    ...
    image:
      "https://images.unsplash.com/photo-1525642441926-d6211d2797e5?auto=format&fit=crop&q=80&w=1000",
    ...
    <div className="max-w-7xl mx-auto flex justify-between items-center">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col justify-center">
          <span className="text-3xl font-serif tracking-wide leading-none text-slate-100 font-medium">
            Wowyatra Signature
          </span>
        </div>
      </div>
...
const Hero = ({ onStart }) => (
  <div
    id="experience"
    className="relative h-[700px] flex items-center justify-center overflow-hidden bg-slate-950"
  >
    ...
    <div className="relative z-10 text-center max-w-5xl px-4 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      ...
      <p className="text-xl md:text-2xl text-slate-300 mb-12 max-w-3xl mx-auto font-light drop-shadow-md leading-relaxed">
        The Power-Packed London Grand. All Attractions Included. Private
        Transfers. <br />
  ...
  <div className="bg-slate-950 py-20 border-b border-slate-900">
    <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
      {[
        ...
        <div
          key={idx}
          className="flex flex-col items-center gap-5 text-slate-400 group hover:text-amber-400 transition-colors"
        >
      ...
      <div className="absolute top-5 left-5 flex gap-2 flex-wrap">
        {pkg.tags.map((tag) => (
          <span
            ...
            } text-[10px] font-bold px-3 py-1.5 rounded-full uppercase tracking-wider shadow-lg`}
          >
            {tag}
          </span>
        ))}
    ...
    <div className="p-8 flex flex-col flex-grow">
      ...
      <div className="pt-6 border-t border-slate-100 flex items-center justify-between mt-auto">
        ...
        {pkg.showPrice ? (
          <div>
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-slate-500 text-sm font-sans font-medium">
                pp*
              </span>
            </div>
          ...
          <div>
            ...
            <div className="flex items-baseline gap-1">
              <p className="font-serif font-bold text-xl text-slate-900">
                Custom Quote
              </p>
            </div>
            <p className="text-slate-400 text-[10px] mt-1 font-medium">
              Bespoke pricing based on needs
            </p>
          </div>
        )}
        ...
        <button
          ...
          onClick={onQuote}
          className={`px-6 py-3 rounded-xl font-bold text-sm tracking-wide transition-all shadow-lg ${
            pkg.isPromo
...
const DealInquiryModal = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (window.jspdf) {
      ...
      doc.setFont("helvetica", "normal");
      doc.text("The Power-Packed London Grand (5 Days)", 60, 84);
      ...
      const itinerary = [
        {
          ...
          desc: "Private luxury transfer from Heathrow to a Premium 4-Star hotel. Leisure time to explore Mayfair.",
        },
        {
          day: "Day 02",
          title: "Royal London & Thames",
          desc: "Private guided tour of Tower of London and Crown Jewels. Afternoon Hop-on Hop-off pass. Sunset Jazz Cruise on the River Thames.",
        },
        {
          day: "Day 03",
          title: "Stonehenge & Bath",
          desc: "Full-day luxury coach expedition to the prehistoric Stonehenge and the historic Roman Baths. Traditional pump room lunch included.",
        },
        {
          day: "Day 04",
          title: "Icons & Shopping",
          desc: "Morning fast-track entry to Madame Tussauds. Afternoon shopping at Oxford Street. Evening flight on The London Eye for sunset views.",
        },
        {
          day: "Day 05",
          title: "Departure",
          desc: "Breakfast at hotel. Private chauffeur transfer to Heathrow Airport for your onward journey.",
        },
      ];
      ...
      doc.setFontSize(14);
      doc.setTextColor(...slate900);
      // FINAL APPROVED PRICE IN PDF
      doc.text("₹89,999 per person", pageWidth - 20, footerY + 5, {
        align: "right",
      });
      doc.setFontSize(8);
    ...
    const templateParams = {
      ...
      package_name: "The Power-Packed London Grand",
      // Pass the PDF data URI if your EmailJS template accepts it (requires advanced tier usually),
      // OR just send the text details.
      my_pdf: pdfDataUri,
    };
    ...
    return (
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in">
        <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl border border-slate-100 relative">
          ...
          <h3 className="text-2xl font-serif text-slate-900 mb-2 font-medium">
            Inquiry Sent!
          </h3>
          <p className="text-slate-500 text-sm mb-8 leading-relaxed">
            Thank you, {formData.name}. We have sent the detailed itinerary to{" "}
            <span className="font-bold text-slate-900">{formData.email}</span>.
            Please check your inbox shortly.
          </p>
          <button
            onClick={onClose}
            className="bg-slate-900 text-white px-8 py-4 rounded-xl font-bold w-full hover:bg-slate-800 uppercase tracking-widest text-sm transition-all shadow-lg"
          >
            Return to Site
          </button>
        </div>
      ...
      <div className="bg-white rounded-2xl max-w-lg w-full overflow-hidden shadow-2xl relative">
        ...
        <div className="bg-slate-900 p-6 flex justify-between items-start text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 bg-amber-500 text-slate-900 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-3">
              <Flame size={12} /> Winter Sale Exclusive
            </div>
            <h3 className="font-serif text-2xl md:text-3xl leading-tight font-medium">
              Unlock the ₹89k Deal
            </h3>
            <p className="text-slate-400 text-xs mt-2 font-medium uppercase tracking-wide">
              Limited Time Offer • London, Stonehenge, Bath
            </p>
          </div>
          <button
            onClick={onClose}
            className="text-slate-400 hover:text-white bg-white/10 p-2 rounded-full hover:bg-white/20 transition-all z-10"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5">
          ...
          >
            {isSubmitting ? (
              ...
              <>
                Get My Quote via Email <ArrowRight size={18} />
              </>
            )}
          </button>

          <p className="text-[10px] text-center text-slate-400 leading-tight px-4">
            By submitting, you agree to receive the itinerary via email.
            Wowyatra Signature respects your privacy.
          </p>
        </form>
      </div>
    </div>
          ...
          <>
              ...
              <div className="space-y-6 animate-in slide-in-from-right-8 duration-300">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500 uppercase tracking-wide font-medium">
                    We customize logistics for group comfort.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <span className="block font-bold text-sm text-slate-900 uppercase tracking-wide">
                        Honeymoon Couple
                      </span>
                      <span className="text-[10px] text-slate-500 font-medium">
                        Private dining & romantic suites.
                      </span>
                    </div>
                  </button>
                  ...
                  >
                    <Users
                      size={22}
                      className={
                        preferences.family ? "text-amber-600" : "text-slate-400"
                      }
                    />
                    <div className="text-left">
                      <span className="block font-bold text-sm text-slate-900 uppercase tracking-wide">
                ...
                <div className="flex justify-end">
                  <button
                    onClick={handleNext}
                    className="bg-slate-900 text-white px-6 py-3 rounded-lg font-bold text-sm flex items-center gap-2 hover:bg-amber-600 transition-colors shadow-lg uppercase tracking-wider"
                  >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <button
                      ...
                      className={`w-full p-4 border rounded-lg text-left text-sm font-bold tracking-wide transition-all flex justify-between ${
            ...
            {step === 3 && (
              <div className="text-center py-8 space-y-6 animate-in zoom-in-95 duration-300">
                ...
                <button
                  onClick={onClose}
                  className="w-full bg-amber-500 text-slate-900 px-4 py-4 rounded-lg font-bold hover:bg-amber-400 text-sm shadow-md uppercase tracking-widest"
                >
                  View My Plan
                </button>
              </div>
    ...
    <div id="contact" className="bg-slate-900 py-24">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className="space-y-6 text-white">
          <h2 className="text-5xl font-serif font-medium text-amber-500">
            Contact Us
          </h2>
          <p className="text-slate-300 text-lg max-w-lg">
            For partnership inquiries, vendor relations (hotels, transport), or
            other general questions, please reach out directly.
          </p>
          ...
          <div className="space-y-3 pt-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-lg text-slate-100">
                Wowyatra Signature, Punjab, INDIA
              </p>
            </div>
          </div>
        </div>
          ...
          {submitted ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 mt-2">
                Thank you. We will respond to your query at
                **info@wowyatrasignature.in** shortly.
              </p>
            </div>
          ) : (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
        <div className="space-y-8">
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            After 15 years spent perfecting travel logistics for top global
            corporations and luxury travel agencies, Wowyatra is finally opening
            its private portfolio to the individual traveler. We don't just book
            trips; we apply the same rigorous, zero-error corporate standards to
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-1">
                  We utilize our established 15-year network of private drivers,
                  secure ticketing systems, and verified ground handlers to
                  ensure your itinerary runs with corporate efficiency.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-xl font-bold text-slate-900">
                  Insider Access and Pricing Power
                </h4>
                <p className="text-slate-600 mt-1">
                  We bypass standard retail pricing, ensuring you get placed in
                  the best rooms and benefit from stable, fixed costs secured
        ...
        <div className="space-y-8">
          <div className="p-8 bg-slate-100 rounded-xl border border-slate-200">
            <h4 className="text-3xl font-serif font-medium text-slate-900 mb-4">
              Protection, Not Just Planning
            </h4>
            <p className="text-slate-700">
              Our B2B experience taught us that peace of mind is priceless. We
              handle every administrative burden so you don't have to:
            </p>
            <ul className="list-none space-y-3 mt-4">
              <li className="flex items-start gap-3">
                <Shield size={20} className="text-red-500 mt-0.5 shrink-0" />
                <span className="text-slate-800 font-medium">
                  Guaranteed Visa Denial Protection.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Phone size={20} className="text-red-500 mt-0.5 shrink-0" />
                <span className="text-slate-800 font-medium">
                  24/7 Concierge (not a call center) for crisis management.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Globe size={20} className="text-red-500 mt-0.5 shrink-0" />
                <span className="text-slate-800 font-medium">
                  Experience, Not Experiments: Our routes are fully road-tested.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="text-center pt-4">
            ...
            <p className="text-slate-600 mt-2 italic">
              We manage the complexity so you and your family can simply enjoy
              the majesty of the UK and Europe, worry-free.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans text-slate-900">
      ...
      <main>
        ...
        <Hero onStart={() => setShowDealModal(true)} />
        ...
        <div id="destinations" className="max-w-7xl mx-auto px-4 py-24">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <h2 className="text-5xl font-serif text-slate-900 mb-6 font-medium">
                Curated UK & Europe Collections
              </h2>
      ...
      {/* 89k Deal Modal */}
      {showDealModal && (
        <DealInquiryModal onClose={() => setShowDealModal(false)} />
      )}
    </div>
  );
};
